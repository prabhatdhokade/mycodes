...
// insertion and deletion is a same thing
#include<bits/stdc++.h>
...
int solve(string s1,int n) {
    int in =0; // number insertion to make a palindrome  (number of insertion deletion both are same numbers,just think aboutit)
    in = n - lps(s1,n); // s1.size() - longest pallindrome length
    return in;
}
